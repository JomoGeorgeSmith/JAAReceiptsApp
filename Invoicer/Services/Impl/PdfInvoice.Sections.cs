...
namespace Invoicer.Services.Impl
{
    public partial class PdfInvoice
    {
        private void HeaderSection()
        {
            ...
            row = subTable.AddRow();
            row.Cells[0].AddParagraph("RECEIPT NUMBER: ", ParagraphAlignment.Left, "H2-9B-Color");
        ...
        private void BillingHeader(Table table)
        {
            ...
            //row.Cells[0].AddParagraph("SERVICE", ParagraphAlignment.Left);
            ...
            //{
            //    row.Cells[0].AddParagraph("DETAILS", ParagraphAlignment.Left);
            ...
            {
                row.Cells[0].AddParagraph("DETAILS", ParagraphAlignment.Left);
                //row.Cells[1].AddParagraph("TOTAL", ParagraphAlignment.Center);
