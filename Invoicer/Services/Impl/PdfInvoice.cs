...
namespace Invoicer.Services.Impl
{
    public partial class PdfInvoice
    {
        ...
        public void Save(string filename, string password = null)
        {
            ...
            emailHelper.SendWithAttachments("jomosmith@hotmail.com", filename);

        }

        public void SaveAndEmail(string email , string filename, string password = null )
        {
            CreateDocument();
            //PdfDocumentRenderer renderer = new PdfDocumentRenderer(true, PdfSharp.Pdf.PdfFontEmbedding.Always);
            PdfDocumentRenderer renderer = new PdfDocumentRenderer(true);
            ...
            emailHelper.SendWithAttachments( filename , email);
